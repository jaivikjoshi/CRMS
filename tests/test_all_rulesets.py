...
class TestUSCA:
    def test_guardrail_wrong_jurisdiction(self):
        ...
        result, fired, _ = evaluate_rules(ctx, CA_RULES, 100)
    ...
    def test_chargeback_event(self):
        ...
        result, fired, _ = evaluate_rules(ctx, CA_RULES, 50)
        assert fired[0].rule_id == "US-CA-SALES-005"
    ...
    def test_resale_cert_valid_b2b_physical(self):
        ...
        result, fired, _ = evaluate_rules(ctx, CA_RULES, 1000)
    ...
    def test_resale_cert_invalid_b2b_physical(self):
        ...
        result, fired, _ = evaluate_rules(ctx, CA_RULES, 500)
        assert fired[0].rule_id == "US-CA-SALES-110"
        assert result["taxable"] is True
    ...
    def test_consumer_physical_shipped_to_ca(self):
        ...
        result, fired, _ = evaluate_rules(ctx, CA_RULES, 200)
...
class TestEU:
    def test_guardrail_wrong_jurisdiction(self):
        ...
        result, fired, _ = evaluate_rules(ctx, EU_RULES, 100)
    ...
    def test_b2b_valid_vat_reverse_charge(self):
        ...
        result, fired, _ = evaluate_rules(ctx, EU_RULES, 500)
    ...
    def test_b2b_missing_vat_id_treated_as_b2c(self):
        ...
        result, fired, _ = evaluate_rules(ctx, EU_RULES, 200)
    ...
    def test_b2b_low_vat_confidence(self):
        ...
        result, fired, _ = evaluate_rules(ctx, EU_RULES, 300)
        assert fired[0].rule_id == "EU-VAT-120"
        assert result["rate"] == 0.20
    ...
    def test_b2c_digital_services(self):
        ...
        result, fired, _ = evaluate_rules(ctx, EU_RULES, 50)
    ...
    def test_b2c_digital_goods(self):
        ...
        result, fired, _ = evaluate_rules(ctx, EU_RULES, 25)
        assert fired[0].rule_id == "EU-VAT-200"
...
class TestCAON:
    def test_digital_saas_consumer_with_evidence(self):
        ...
        result, fired, _ = evaluate_rules(ctx, ON_RULES, 100)
    ...
    def test_digital_goods_consumer_with_evidence(self):
        ...
        result, fired, _ = evaluate_rules(ctx, ON_RULES, 50)
        assert fired[0].rule_id == "CA-ON-HST-010"
...
class TestUSTX:
    def test_saas_consumer_taxable(self):
        ctx = _ctx({"jurisdiction": "US-TX", "tax_type": "SALES", "amount": 100, "buyer": {"type": "CONSUMER"}, "product": {"category": "SAAS"}})
        result, fired, _ = evaluate_rules(ctx, TX_RULES, 100)
    ...
    def test_digital_consumer_taxable(self):
        ...
        result, fired, _ = evaluate_rules(ctx, TX_RULES, 200)
        assert result["taxable"] is True
    ...
    def test_b2b_saas_exempt(self):
        ...
        result, fired, _ = evaluate_rules(ctx, TX_RULES, 1000)
...
class TestUSNY:
    def test_saas_consumer_taxable(self):
        ...
        result, fired, _ = evaluate_rules(ctx, NY_RULES, 100)
...
class TestOperators:
    def test_neq(self):
        ...
        result, fired, _ = evaluate_rules(_ctx({"jurisdiction": "US-TX", "amount": 100}), rules, 100)
    ...
    def test_gt(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"amount": 100}), rules, 100)
        assert result["taxable"] is True
        result2, _, _ = evaluate_rules(_ctx({"amount": 30}), rules, 30)
    ...
    def test_in_operator(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"product": {"category": "SAAS"}, "amount": 100}), rules, 100)
        assert result["taxable"] is True
        result2, _, _ = evaluate_rules(_ctx({"product": {"category": "TANGIBLE"}, "amount": 100}), rules, 100)
        assert result2["taxable"] is False
    ...
    def test_exists(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"buyer": {"vat_id": "DE123"}, "amount": 100}), rules, 100)
        assert result["taxable"] is True
        result2, _, _ = evaluate_rules(_ctx({"buyer": {}, "amount": 100}), rules, 100)
        assert result2["taxable"] is False
    ...
    def test_not_exists(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"amount": 100}), rules, 100)
        assert result["taxable"] is True
        result2, _, _ = evaluate_rules(_ctx({"doc": {"resale_cert_valid": True}, "amount": 100}), rules, 100)
        assert result2["taxable"] is False
    ...
    def test_path_neq(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"evidence": {"billing_country": "US", "ip_country": "DE"}, "amount": 100}), rules, 100)
        assert result["taxable"] is True
        result2, _, _ = evaluate_rules(_ctx({"evidence": {"billing_country": "US", "ip_country": "US"}, "amount": 100}), rules, 100)
        assert result2["taxable"] is False
    ...
    def test_any_combinator(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"buyer": {"type": "CONSUMER"}, "amount": 100}), rules, 100)
        assert result["taxable"] is True
    ...
    def test_all_combinator(self):
        ...
        result, _, _ = evaluate_rules(_ctx({"buyer": {"type": "CONSUMER"}, "amount": 100}), rules, 100)
        assert result["taxable"] is True
        result2, _, _ = evaluate_rules(_ctx({"buyer": {"type": "CONSUMER"}, "amount": 10}), rules, 10)
        assert result2["taxable"] is False
    ...
    def test_first_match_wins(self):
        ...
        result, fired, _ = evaluate_rules(_ctx({"amount": 100}), rules, 100)
